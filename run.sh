...
if [ -z "$OPENAI_API_KEY" ]; then
    ...
    echo "   export CATEGORIES=\"cs.RO, cs.CV, cs.AI, cs.LG, cs.CL, cs.SI\"  # 关注分类 / Categories of interest"
    ...
    export CATEGORIES="${CATEGORIES:-cs.RO, cs.CV, cs.AI, cs.LG, cs.CL, cs.SI}"
